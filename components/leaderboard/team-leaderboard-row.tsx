...
export function TeamLeaderboardRow({ team }: TeamLeaderboardRowProps) {
  ...
  return (
    <>
      {/* Desktop Layout */}
      <div className="hidden md:flex md:gap-3 xl:gap-4">
        {/* Rank */}
        ...
        {/* Team Name */}
        <div className="flex-shrink-0 hidden lg:block w-48 xl:w-56">
          <div className="bg-white rounded-2xl px-4 py-3 xl:py-4 h-14 xl:h-16 flex items-center justify-center shadow-sm">
        ...
        {/* Combined Scores */}
        <div className="flex-1 w-80 xl:w-96">
      ...
      {/* Mobile Layout */}
      <div className="md:hidden bg-white rounded-2xl p-4 sm:p-6 shadow-lg">
        {/* Header Row */}
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-sm sm:text-base text-gray-600 font-medium">Team</div>
            </div>
          </div>
        ...
        {/* Team Members */}
        <div className="mb-2 py-2 px-1 bg-gray-50 rounded-xl">
        ...
        <div className="bg-gray-50 rounded-xl p-4">
          ...
          <div className="grid grid-cols-6 gap-2">
            {safeTeam.combinedScores.map((score, index) => (
              <div key={index} className="bg-white rounded-lg py-1 px-2 text-center">
                <div className="text-xs text-gray-500 mb-0.5">Q{index + 1}</div>
